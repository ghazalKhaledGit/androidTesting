...
import kotlinx.android.synthetic.main.activity_sub_category1.*
...
class SubCategory1 : AppCompatActivity() {
    ...
    fun SearchInDatabase(SearchText:String, startFrom:Int){
        val url = "http://10.0.2.2/CommerceServer/cProductList.php?op=cat1&query=$SearchText&StartFrom=$startFrom"
    ...
    inner class MyCategoryAdpater : BaseAdapter {
        ...
        override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
            ...
            var myView = layoutInflater.inflate(R.layout.category1_ticket, null)
            ...
            val url = "http://10.0.2.2/CommerceServer/cProductList.php?op=cat1&query=myProduct.tProductNum&StartFrom=0"
            MyCategoryAsyncTask().execute(url)
    ...
    fun goToSubCategory(myProduct:SuperTicketClass){
        val intent=Intent(this,SubCategory2::class.java)
