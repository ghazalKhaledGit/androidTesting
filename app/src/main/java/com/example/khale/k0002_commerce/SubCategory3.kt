...
import kotlinx.android.synthetic.main.activity_sub_category3.*
...
class SubCategory3 : AppCompatActivity() {
  ...
  Toast.makeText(this,"catagory 3 ", Toast.LENGTH_LONG).show()
    ...
    inner class MyCategoryAdpater : BaseAdapter {
        ...
        override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
            ...
            var myView = layoutInflater.inflate(R.layout.category3_ticket, null)
    ...
    fun goToSubCategory(myProduct:SuperTicketClass){
        ...
        /*
           val intent=Intent(this,SubCategory3::class.java)
